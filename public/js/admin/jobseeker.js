function load_job_popup(method, id){
		...
		// Make an ajax call
		var myurl = baseUrl+'admin/jobseeker/'+method+'/'+id;
...
$("#frm_job").on('submit',(function(e){
		  ...
		  $.ajax({
		  		url: baseUrl+"admin/jobseeker/"+method+'/'+jid,
		  		type: "POST",
...
function delete_job(id){
	var myurl = baseUrl+'admin/jobseeker/delete/'+id;
	var is_confirm = confirm("Are you sure you want to delete this jobseeker?");
	if(is_confirm){
...
function update_job_status(id){
	...
	var myurl = baseUrl+'admin/jobseeker/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
