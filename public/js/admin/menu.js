...
$("#frm_menu").on('submit',(function(e){
		  ...
		  $.ajax({
		  		url: baseUrl+"admin/menu/"+method+'/'+pid,
		  		type: "POST",
...
$("#select_menu_btn").on('click',(function(e){
		...
		if(selected_menu_id!=''){
			...
			var myurl = baseUrl+'admin/menu/load_menu_pages/'+selected_menu_id;
			$.getJSON(myurl, function (obj_data) {
			//$("#msg_box").html(obj_data.msg);
...
$("#pselectedfrm").on('submit',(function(e){
		  ...
		  $.ajax({
		  		url: baseUrl+"admin/menu/add_menu_pages",
		  		type: "POST",
		  		data:  new FormData(this),
		  		contentType: false,
		  		cache: false,
...
function delete_menu(id){
	var myurl = baseUrl+'admin/menu/delete/'+id;
...
function delete_menu_page(id){
	var myurl = baseUrl+'admin/menu/delete_menu_page/'+id;
