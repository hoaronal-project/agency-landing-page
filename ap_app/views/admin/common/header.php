<header class="header"> <a href="<?php echo base_url();?>admin/dashboard" class="logo"> <?php echo SITE_NAME;?> </a>
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span><?php echo $this->session->userdata('name');?></span> </a>
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left"> <a href="<?php echo base_url('admin/changepass');?>" class="btn btn-default btn-flat">Edit</a> </div>
