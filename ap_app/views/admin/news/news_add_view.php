  ...
  <div class="tab-content">
    <div class="tab-pane fade in active">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="news_title" name="news_title" value="" placeholder="News Title">
        </div>
      
      <div class="form-group">
        <label  for="exampleInputPassword1">News Image</label>
        <input type="file" class="form-control"  id="news_image" name="news_image" value="">
      </div>
        <div class="form-group">
