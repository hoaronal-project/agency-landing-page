      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Applications Received for the post of <strong>"<?php echo @$result[0]->job_title ;?>"</strong></h3>
            <!--Pagination-->
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><a download href="<?php echo base_url('public/uploads/resume/'.$row->resume);?>">Download Resume</a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
