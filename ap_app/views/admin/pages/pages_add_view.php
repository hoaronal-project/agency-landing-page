  ...
  <div class="tab-content">
    <div id="pdetails" class="tab-pane fade in active">
      ...
      <div class="form-group">
        ...
        <input type="file" class="form-control"  id="pageImage" name="pageImage" value="<?php echo set_value('pageImage');?>">
        <?php echo form_error('pageImage'); ?> <br />
        <img id="img_preview" src="#" style="max-width:200px;" /> </div>
      <div class="form-group">
       <input type="checkbox" name="menuTop" id="menuTop" value="1" /> Show in Header Menu
       <br />
       <input type="checkbox" name="menuBottom" id="menuBottom" value="1" /> Show in Footer Menu
        </div>
    </div>
