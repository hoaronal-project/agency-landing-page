...
<div class="container">
  ...
  <div class="alert alert-danger"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> <strong>Error!</strong> <?php echo $this->session->flashdata('err_applied');?> </div>
  <?php endif;?>
  <div class="row">
    <div class="col-md-4">
    	<div class="staffingsidebar">
      <img src="<?php echo base_url('public/images/staffing.jpg');?>" />
      </div>
    </div>
    <div class="col-md-8"> <?php echo get_site_url($common_row->tech_text);?>
      <div class="boxwraper">
        <div class="titlebar"> <b>Jobs In Tech Friends</b> </div>
        <ul class="searchlist">
